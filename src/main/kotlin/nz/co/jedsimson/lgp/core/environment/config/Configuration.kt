...
class Configuration {
    ...
    override fun toString(): String {
        ...
        sb.appendLine("\tinitialMinimumProgramLength = $initialMinimumProgramLength")
        sb.appendLine("\tinitialMaximumProgramLength = $initialMaximumProgramLength")
        sb.appendLine("\tminimumProgramLength = $minimumProgramLength")
        sb.appendLine("\tmaximumProgramLength = $maximumProgramLength")
        sb.appendLine("\toperations = $operations")
        sb.appendLine("\tconstantsRate = $constantsRate")
        sb.appendLine("\tconstants = $constants")
        sb.appendLine("\tnumCalculationRegisters = $numCalculationRegisters")
        sb.appendLine("\tpopulationSize = $populationSize")
        sb.appendLine("\tnumFeatures = $numFeatures")
        sb.appendLine("\tcrossoverRate = $crossoverRate")
        sb.appendLine("\tmicroMutationRate = $microMutationRate")
        sb.appendLine("\tmacroMutationRate = $macroMutationRate")
        sb.appendLine("\tgenerations = $generations")
        //sb.appendLine("\tnumOffspring = $numOffspring")
        sb.appendLine("\tbranchInitialisationRate = $branchInitialisationRate")
        sb.appendLine("\tstoppingCriterion = $stoppingCriterion")
